...
public class HapticPlugin : MonoBehaviour
{
    ...
    //修改
    public double[] Touch_Rpy = new double[3];   // pyr
    //修改
    public double[] Touch_Position = new double[3];
    ...
    // 修改
    public int[] my_Buttons = new int[4];
    int[] Buttons;
    int[] LastButtons;
    int inkwell;
    ...
    //修改
    public Matrix4x4 DeviceTransformRotation;
    ...
    //修改
    public void GetDeviceTransformationRotation()
    {
        //only rotation
        double[] matInput = new double[16];
        getTransform(DeviceIdentifier, matInput);
        ...
        mat.m22 = (float)matInput[10];
        mat.m23 = (float)matInput[11];
        mat.m30 = (float)matInput[12] * 0;
        mat.m31 = (float)matInput[13] * 0;
        mat.m32 = (float)matInput[14] * 0;
        mat.m33 = (float)matInput[15];
        DeviceTransformRotation = mat.transpose;
    ...
    public void UpdateDeviceInformation()
    {
        ...
        //修改
        Array.Copy(temp_double_array, Touch_Position, temp_double_array.Length);
       ...
       // }
        ...
        //修改
        GetDeviceTransformationRotation();
        ...
        //修改
        Array.Copy(temp_double_array2, Touch_Rpy, temp_double_array2.Length);
