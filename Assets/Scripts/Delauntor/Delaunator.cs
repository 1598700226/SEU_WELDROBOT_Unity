...
using Algorithm.Delauntor.Models;

using Point = Algorithm.Delauntor.Models.Point;

namespace Algorithm.Delauntor
{
    public class Delaunator
    {
        ...
        public IPoint[] GetHullPoints() => Array.ConvertAll(Hull, (x) => Points[x]);
