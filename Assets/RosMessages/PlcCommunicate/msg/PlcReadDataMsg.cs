...
{
    [Serializable]
    public class PlcReadDataMsg : Message
    {
        public const string k_RosMessageName = "plc_communicate/PlcReadData";
        ...
        public float env_temp;
        public float env_humi;

        public PlcReadDataMsg()
        {
        ...
        public PlcReadDataMsg(bool plc_pulse, bool plc_ready, bool plc_automatic, bool plc_manual, bool plc_reset, bool laser_enable, bool laser_error, bool laser_working, bool open_instruction, bool open_gas, bool open_powder, ushort current_power, ushort current_speed, ushort current_product, ushort current_technology, float env_temp, float env_humi)
        {
            ...
            this.env_humi = env_humi;
        }

        public static PlcReadDataMsg Deserialize(MessageDeserializer deserializer) => new PlcReadDataMsg(deserializer);

        private PlcReadDataMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.env_temp);
            deserializer.Read(out this.env_humi);
        }
        ...
        public override void SerializeTo(MessageSerializer serializer)
        {
            ...
            serializer.Write(this.env_temp);
            serializer.Write(this.env_humi);
        }

        public override string ToString()
        {
            return "PlcReadDataMsg: " +
            ...
            "\nenv_temp: " + env_temp.ToString() +
            "\nenv_humi: " + env_humi.ToString();
        }
